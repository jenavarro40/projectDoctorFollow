...
class DoctorFoodFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val food:FoodRequest= FoodRequest(name!!,email!!,doctor!!)
        firestoreHelper.foodRequest(requireContext(),food)
        val text=view.findViewById<TextView>(R.id.foodText)
        text.setText("You have successfully assigned patient ${name}")
    }
